...
let append = (data) =>{
    ...
    data.forEach(({img,title,shop_name,location,details,rating,contains,discount})=>{
        let aimg = doc('img')
        aimg.src = img
        ...
        let adiscount = doc('p')
        adiscount.innerHTML = `KindMeal Discount ${discount}`
        down_div.append(acontains,adiscount)
        let div = doc('div')
